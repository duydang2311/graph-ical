namespace graphical {
    class Circle : Shape {
        ...
        override public void Draw(System.Drawing.Graphics graphic, decimal ratio) {
            if(this.hovering) {
                graphic.FillEllipse(System.Drawing.Brushes.Black, (int)(this.anchor.X * ratio), (int)(this.anchor.Y * ratio), (int)(2 * this.radius * ratio), (int)(2 * this.radius * ratio));
                ...
                using (System.Drawing.Pen pen = new System.Drawing.Pen(this.color, (float)(2 * ratio))) {
                    graphic.DrawEllipse(pen, (int)(this.anchor.X * ratio), (int)(this.anchor.Y * ratio), (int)(2 * this.radius * ratio), (int)(2 * this.radius * ratio));
                    graphic.FillEllipse(System.Drawing.Brushes.White, (int)(this.anchor.X * ratio), (int)(this.anchor.Y * ratio), (int)(2 * this.radius * ratio), (int)(2 * this.radius * ratio));
                    using(System.Drawing.Font font = new System.Drawing.Font("Arial", 20 * (float)ratio, System.Drawing.GraphicsUnit.Pixel)) {
                        using(System.Drawing.StringFormat stringFormat = new System.Drawing.StringFormat()) {
                            stringFormat.LineAlignment = System.Drawing.StringAlignment.Center;
                            stringFormat.Alignment = System.Drawing.StringAlignment.Center;
        ...
        public override bool IsPointCollided(Point point, decimal ratio) {
            double ratioRadius = (double)(2 * this.radius * ratio);
        ...
        public override int CenterX {
            get => this.anchor.X + this.radius;
        }
        public override int CenterY {
            get => this.anchor.Y + this.radius;
        }
    }
}